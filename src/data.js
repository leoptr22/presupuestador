...
export const materials = [
  ...
  { id:'papel', name:'Papel Blueback', category:'Impresión por m²', unit:'m²', prices:printPrices(8900,14500,20600,12600,20300,28800,16400,26400,37400), desc:'Papel para cartelería de corta duración' },
  ...
  { id:'vinilo-lg', name:'Vinilo LG 1800 / Inflex 100 mic', category:'Impresión por m²', unit:'m²', prices:printPrices(14000,19600,25700,19900,27500,35900,25800,35700,46700), desc:'Vinilo autoadhesivo de uso general' },
  { id:'oracal', name:'Oracal 3164', category:'Impresión por m²', unit:'m²', prices:printPrices(21200,27000,33300,30100,37800,46500,39100,49100,60500), desc:'Vinilo de mayor durabilidad' },
  { id:'micro', name:'Vinilo microperforado', category:'Impresión por m²', unit:'m²', prices:printPrices(17400,23400,29900,24700,32800,41800,32100,42600,54300), desc:'Permite visión desde el interior' },
  ...
  { id:'lona-front', name:'Lona Front 13 oz', category:'Impresión por m²', unit:'m²', prices:printPrices(11700,17700,24200,16600,24800,33800,21600,32200,43900), desc:'Lona resistente para carteles y banners' },
  { id:'lona-back', name:'Lona Back Light', category:'Impresión por m²', unit:'m²', prices:printPrices(16400,25000,32100,23200,35000,44900,30200,45500,58300), desc:'Para carteles retroiluminados' },
  ...
  { id:'esmerilado-imp', name:'Esmerilado impreso', category:'Impresión por m²', unit:'m²', prices:printPrices(18400,24400,30900,26100,34100,43200,33900,44400,56100), desc:'Privacidad con diseño personalizado' },
  { id:'iman-imp', name:'Imán 1,20 m impreso', category:'Impresión por m²', unit:'m²', prices:printPrices(50100,56100,62600,71200,78600,87600,92500,102100,113900), desc:'Se cobra el ancho total' },
  { id:'suncatcher', name:'Vinilo SUNCATCHER Clear NEW', category:'Especiales UV por m²', unit:'m²', uvOnly:true, prices:printPrices(null,33700,40000,null,46200,56000,null,60000,72700), desc:'Material especial disponible sólo en UV' },
  { id:'tornasolado', name:'Vinilo tornasolado Clear NEW', category:'Especiales UV por m²', unit:'m²', uvOnly:true, prices:printPrices(null,29400,35700,null,43200,48100,null,56200,62500), desc:'Efecto tornasolado decorativo' },
  ...
  { id:'glitter', name:'Vinilo glitter', category:'Especiales UV por m²', unit:'m²', uvOnly:true, prices:printPrices(null,29400,35700,null,39700,48100,null,51600,62500), desc:'Terminación brillante con destellos' },
  { id:'espejado', name:'Vinilo espejado cepillado Silver / Gold', category:'Especiales UV por m²', unit:'m²', uvOnly:true, prices:printPrices(null,48400,54700,null,66800,73800,null,86900,95900), desc:'Acabado espejado dorado o plateado' },
  ...
  { id:'reflectivo', name:'Reflectivo blanco 1,20 m ancho', category:'Especiales UV por m²', unit:'m²', uvOnly:true, prices:printPrices(null,33300,39400,null,46300,55100,null,60200,71600), desc:'Alta visibilidad nocturna' },
  ...
  { id:'ecocuero', name:'Ecocuero 1,40 m ancho', category:'Impresión por m²', unit:'m²', prices:printPrices(11200,21500,27500,null,30100,38500,null,39100,50100), desc:'Textura símil cuero personalizada' },
  { id:'termo-transferible', name:'Vinilo termo transferible', category:'Especiales UV por m²', unit:'m²', uvOnly:true, prices:printPrices(null,52200,57800,null,73000,80900,null,94900,105200), desc:'Vinilo termo transferible disponible en UV' },

  // Terminaciones y productos
  { id:'corte-recto', name:'Corte recto por m²', category:'Terminaciones', unit:'m²', independent:true, prices:prices(2400,null,3200,null,4100,null), desc:'Corte recto del material' },
  { id:'corte-profundo', name:'Corte profundo por contorno', category:'Terminaciones', unit:'m²', independent:true, prices:prices(6700,null,9000,null,11700,null), desc:'Corte profundo por contorno por m²' },
  { id:'troquel', name:'Troquel por m²', category:'Terminaciones', unit:'m²', independent:true, prices:prices(3100,null,4200,null,5500,null), desc:'Troquel / medio corte por m²' },
  { id:'laca', name:'Laca UV', category:'Terminaciones', unit:'m²', independent:true, prices:prices(22900,null,30900,null,40200,null), desc:'Protección y acabado con laca UV' },
  ...
  { id:'domes', name:'DOMES UV digital con troquel incluido', category:'Especiales UV por m²', unit:'m²', uvOnly:true, prices:printPrices(null,null,30500,null,null,42650,null,null,55500), desc:'Se calcula por medidas, con troquel incluido' },
  ...
  { id:'corte-oracal651', name:'Colores comunes Oracal 651', category:'Vinilos de corte', unit:'ml', billing:'linear', independent:true, prices:prices(27130,null,33910,null,44080,null), desc:'Vinilo de corte Oracal 651 por metro lineal' },
  ...
  { id:'ml-oracal651-color', name:'Oracal 651 colores', category:'Material sin corte', unit:'ml', billing:'linear', independent:true, prices:prices(16170,null,20210,null,26280,null), desc:'Material sin corte por metro lineal' },
